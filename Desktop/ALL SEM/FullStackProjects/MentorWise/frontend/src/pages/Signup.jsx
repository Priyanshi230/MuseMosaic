...
const Signup = () => {
  ...
  const handleFileInputChange = async(event) =>{
    ...
    const file = event.target.files[0]
       // later we will use cloudinary to upload a image
   // console.log(file)
  };
     ...
     <div className='max-w-[1170px] mx-auto'>
      <div className='grid grid-cols-1 lg:grid-cols-2'>
         ...
         <div className='mb-5'>
          ...
          focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placholder:text-textColor cursor-pointer"
          required
         />
        </div>
        ...
        <div className='mb-5 flex items-center justify-between'>
          <label className='text-headingColor font-bold text-[16px] lading-7'>
            Are you a :
            <select 
            name="role"
            value={formData.role}
      ...
      <div className='mb-5 flex items-center gap-3'>
         ...
         flex items-center justify-center'>
            <img src = {avataricon} alt ="" className='w-full rounded-full'/>
