...
import mentor01 from "../../assets/images/mentor01.png";
import Star from "../../assets/images/Star.png";
import { services } from '../../assets/images/data/services';
import ProfessorAbout from './ProfessorAbout';
        ...
        <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              <figure className='max-w-[200px] max-h-[200px]'>
                <img src = {mentor01} alt =""/>
              </figure>

              <div >
                <span className='bg-[#CCF0FC] text-irishBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded '>
                 Neural Networks 
                </span>
