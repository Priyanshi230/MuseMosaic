...
const FaqItems = ({ item }) => {
  ...
  return(
    <div className='p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] mb-2
    cursor-pointer'>
    <div className='flex items-center justify-between gap-5' onClick ={toogleAccordion}>
